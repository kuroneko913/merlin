...
wav_dir="${merlin_dir}/tools/GlottHMM/data/wav"

# Output features directory
out_dir="${merlin_dir}/tools/GlottHMM/data"

f0_dir="${out_dir}/F0"
lsf_dir="${out_dir}/lsf"
hnr_dir="${out_dir}/hnr"
lsfsource_dir="${out_dir}/lsfsource"
gain_dir="${out_dir}/gain"
lf0_dir="${out_dir}/lf0"
resyn_dir="${out_dir}/resyn"
...
mv $wav_dir/*.F0 $f0_dir
mv $wav_dir/*.LSF $lsf_dir
mv $wav_dir/*.Gain $gain_dir
mv $wav_dir/*.LSFsource $lsfsource_dir
mv $wav_dir/*.HNR $hnr_dir
